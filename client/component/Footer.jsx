      ...
      <div className="footer">
        <div className="footer__block">
          ...
          <span className="footer__legal">
            <div>Copyright &copy; 2018 <a href="https://dogecashcrypto.com/">DogeCash Cryptocurrency</a></div>
            <div>Site design / Logo &copy; 2018 <a href="https://dogecashcrypto.com/">DogeCash Cryptocurrency</a></div>
          </span>
        </div>
        <div className="footer__block">
        ...
        <div className="footer__block">
          <div className="footer__social-media-wrapper">
            ...
            <div>
              ...
              <a href="https://t.me/dogecashcrypto" target="_blank">
              ...
              <a href="https://github.com/dogecash-crypto" target="_blank">
                <Icon name="github" className="fab footer__social-media-icon" />
              </a>
              <a href="https://twitter.com/DogeCashCoin" target="_blank">
                <Icon name="twitter" className="fab footer__social-media-icon" />
              </a>
              <a href="http://facebook.com/dogecash.coin.IO/" target="_blank">
