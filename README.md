![DogeCash Logo](https://dogecashcrypto.com/wp-content/uploads/2018/04/blockexplorer.svg)
...
## Install
`git clone https://github.com/dogecash-crypto/dogecash-explorer.git` - copy repo to local folder.
