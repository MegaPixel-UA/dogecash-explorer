...
server {
    ...
    #server_name explorer.dogecashcrypto.com;
    server_name _;
    ...
    #ssl_certificate /etc/letsencrypt/live/explorer.dogecashcrypto.com/fullchain.pem; # managed by Certbot
    #ssl_certificate_key /etc/letsencrypt/live/explorer.dogecashcrypto.com/privkey.pem; # managed by Certbot
    #include /etc/letsencrypt/options-ssl-nginx.conf; # managed by Certbot
    #ssl_dhparam /etc/letsencrypt/ssl-dhparams.pem; # managed by Certbot
}

#server {
#    if ($host = explorer.dogecashcrypto.com) {
